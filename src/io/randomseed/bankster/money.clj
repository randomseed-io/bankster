...
(defn div
  ...
  Scaling is applied only when the result is a kind of money. If the scaling requires
  rounding then enclosing the expression within with-rounding is required."
  {:added "1.0.0"}
  ([a] (div 1M a))
  ([a b]
   (let [am (when (instance? Money a) (.amount ^Money a))
