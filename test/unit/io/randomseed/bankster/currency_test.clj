...
(deftest new-currency
  ...
  (testing "when it returns a currency object"
    ...
    (is (map= (c/new :crypto/EUR) {:id :crypto/EUR :domain :CRYPTO :kind nil :numeric -1 :scale -1 :weight 0}))
    (is (map= (c/new :EUR 1000) {:id :EUR :domain nil :kind nil :numeric 1000 :scale -1 :weight 0}))
    ...
    (is (map= (c/new :EUR 1000 c/auto-scaled) {:id :EUR :domain nil :kind nil :numeric 1000 :scale -1 :weight 0}))
    (is (map= (c/new :EUR 1000 2 :FIAT) {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale 2 :weight 0}))
    (is (map= (c/new :EUR c/no-numeric-id c/auto-scaled :FIAT) {:id :EUR :domain nil :kind :FIAT :numeric -1 :scale -1 :weight 0}))
    (is (map= (c/new :EUR 1000 c/auto-scaled :FIAT) {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale -1 :weight 0}))
    ...
    (is (map= (c/new {:id :EUR :numeric 1000}) {:id :EUR :domain nil :kind nil :numeric 1000 :scale -1 :weight 0}))
    ...
    (is (map= (c/new {:id :EUR :numeric 1000 :scale c/auto-scaled}) {:id :EUR :domain nil :kind nil :numeric 1000 :scale -1 :weight 0}))
    (is (map= (c/new {:id :EUR :numeric 1000 :scale 2 :kind :FIAT}) {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale 2 :weight 0}))
    ...
    (is (map= (c/new {:id :EUR :numeric 1000 :scale c/auto-scaled :kind :FIAT}) {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale -1 :weight 0}))
...
(deftest currency-tagged-literal
  ...
  (testing "when it returns a currency object"
    ...
    (is (map= #currency {:id :EUR :numeric 1000} {:id :EUR :domain nil :kind nil :numeric 1000 :scale -1 :weight 0}))
    (is (map= #currency {:id :EUR :scale 2} {:id :EUR :domain nil :kind nil :numeric -1 :scale 2 :weight 0}))
    (is (map= #currency {:id :EUR :numeric 1000 :scale 2 :kind :FIAT} {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale 2 :weight 0}))
    (is (map= #currency {:id :EUR :kind :FIAT} {:id :EUR :domain nil :kind :FIAT :numeric -1 :scale -1 :weight 0}))
    (is (map= #currency {:id :EUR :numeric 1000 :kind :FIAT} {:id :EUR :domain nil :kind :FIAT :numeric 1000 :scale -1 :weight 0}))
...
(deftest currency-properties
  ...
  (testing "when it's possible to check if a currency has particular kind"
    (is (= (c/kind-of? #currency EUR :FIAT) true))
    (is (= (c/kind-of? #currency crypto/ETH :DECENTRALIZED) true))
    (is (= (c/kind-of? #currency{:id :PLN :scale 1} :FIAT) false)))
